...
$stmtImages = $pdo->prepare("SELECT image_path FROM img_products WHERE ProductID = ?");
    ...
    <div class="row">
        <div class="col-lg-5 col-md-6 col-sm-6">
            <div class="product-imgs">
                <div class="img-display">
                    <div class="img-showcase">
                        <img src="<?= $ProductImage ?>" alt="shoe image">
                        <?php
                        foreach ($productImages as $image) {
                            $imagePath = $image['image_path'];
                            echo '<img style="margin: 0 10px;" src="' . $imagePath . '" alt="" width="50px">';
                        }
                        ?>
                    </div>
                </div>
                <div class="img-select">
                    <div class="img-item" style="display: flex;">
                        <?php
                        $counter = 1;
                        foreach ($productImages as $image) {
                            $imagePath = $image['image_path'];
            ...
            <a href="#" data-id="' . $counter . '">
                <img style="margin: 0 10px;" src="' . $imagePath . '" alt="" width="50px">
            </a>';
                            $counter++;
                        }
                        ?>
            ...
            <div class="row">
                ...
                <form action="index.php?act=ProductDetail&idpro=<?= $ProductID ?>" method="POST">
                    <div class="comment-ipnut">
                        ...
                        ?>
                        <input type="hidden" name="Timestamp" value="<?= $currentDateTimeVietnam ?>">
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 col-6">
                    <div class="ltn__product-item text-center">
                        <div class="product-img">
                            <a href="' . $linkProduct . '"><img src="' . $ProductImage . '" alt="#"></a>
