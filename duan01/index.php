        ...
        case 'ProductDetail':
            if (isset($_POST['guibinhluan'])) {
                ...
                if (empty(trim($_POST['CommentText']))) {
                    ...
                    insert_binhluan($_POST['ProductID'], $UserID, $_POST['CommentText'], $_POST['Timestamp']);
                }
            }
        ...
        case 'Order':
            if (isset($_POST['order']) && !empty($_POST['order'])) {
                ...
                foreach ($_POST['products'] as $product) {
                    ...
                    insertOrder($ProductID, $UserID, $OrderDate, $StatusID, $PaymentMethodID, $quantity, $Address, $PhoneNumber);
                }
